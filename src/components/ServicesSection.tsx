              ...
              {massSchedules.length > 0 ? (
                <div className="space-y-4">
                  {massSchedules.map((mass, index) => (
                    <SectionFadeIn key={mass.id} direction="up" delay={index * 0.08}>
                      <div className="pb-2">
                        <h4 className="text-base font-semibold text-gray-900 mb-1">{mass.day_type}</h4>
                        <div className="flex flex-wrap gap-2 mb-1">
                          {mass.times.map((time, tIndex) => (
                            <span
                              key={tIndex}
              ...
              <div className="relative h-80 overflow-hidden">
                <div className="space-y-4 animate-scroll-up">
                  {sacraments.concat(sacraments).map((sacrament, index) => (
                    <SectionFadeIn key={`${sacrament.id}-${index}`} direction="up" delay={index * 0.08}>
                      <div className="pb-2">
            ...
            <CardContent className="p-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  <SectionFadeIn key={title} direction="up" delay={index * 0.08}>
